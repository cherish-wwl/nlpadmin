<style>
	...
	.expendIcon {
	    ...
	    background-image: url("../../assets/ztree/zTreeStandard.png");
	}
	...
	.ztree li ul.line{ background:url('../../assets/ztree/line_conn.gif') 0 0 repeat-y;}
	...
	.ztree li span.button {line-height:0; margin:0; width:16px; height:16px; display: inline-block; vertical-align:middle;
		...
		background-image:url("../../assets/ztree/zTreeStandard.png"); *background-image:url("../../assets/ztree/zTreeStandard.gif")}
	...
	/*.ztree li span.button.ico_loading{margin-right:2px; background:url('../../assets/ztree/loading.gif') no-repeat scroll 0 0 transparent; 
	...
	span.tmpzTreeMove_arrow {width:16px; height:16px; display: inline-block; padding:0; margin:2px 0 0 1px; border:0 none; position:absolute;
		...
		background-position:-110px -80px; background-image:url("../../assets/ztree/zTreeStandard.png"); *background-image:url("../../assets/ztree/zTreeStandard.gif")}
        ...
        ztreeItem:{
            ...
            `<li :class="liClassVal">
							<span :class="spanClassVal" @click='open(model)'></span>
								<a  @mouseleave='leaveFunc(model)'  @contextmenu.prevent='cxtmenufunc(model)'>
